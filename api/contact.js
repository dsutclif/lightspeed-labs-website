...
export default async function handler(req, res) {
  ...
  try {
    ...
    const AIRTABLE_CONTACT_TABLE = process.env.AIRTABLE_CONTACT_TABLE || 'Contact Forms';
    ...
    // Submit to Airtable
    const airtableResponse = await fetch(`https://api.airtable.com/v0/${AIRTABLE_BASE_ID}/${AIRTABLE_CONTACT_TABLE}`, {
      method: 'POST',
      headers: {
